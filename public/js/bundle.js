...
svg.style('background-color', 'red'); //creating and editting circle

var g = svg.append('g').attr('transform', 'translate(250,200)');
var circle = g.append('circle');
circle.attr('r', 200).attr('cx', 0).attr('cy', 0).attr('fill', 'yellow').attr('stroke', 'black');
var left_eye = g.append('circle');
left_eye.attr('r', 30).attr('cx', -80).attr('cy', -100).attr('fill', 'black').attr('stroke', 'black');
var right_eye = g.append('circle');
right_eye.attr('r', 30).attr('cx', 80).attr('cy', -100).attr('fill', 'black').attr('stroke', 'black');
